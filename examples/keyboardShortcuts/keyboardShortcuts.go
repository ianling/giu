...
func loop() {
	giu.Window("Window 2").
		RegisterKeyboardShortcuts([]giu.WindowShortcut{
			{giu.KeyZ, giu.ModControl, func() { checkbox2 = !checkbox2 }},
		}...).
		Layout(
...
func main() {
	wnd := giu.NewMasterWindow("keyboard shortcuts", 640, 480, 0, nil).
		RegisterKeyboardShortcuts([]giu.WindowShortcut{
			{giu.KeyC, giu.ModControl, func() { checkbox1 = !checkbox1 }},
		}...)
